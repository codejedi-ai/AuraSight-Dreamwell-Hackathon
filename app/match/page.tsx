    ...
    switch (step) {
      case 1:
        return (
          <>
            <div className="mb-6">
              <Label htmlFor="brand-name" className="block font-medium mb-2 text-gray-700 dark:text-gray-200">
                Brand Name
              </Label>
              <Input
                id="brand-name"
            ...
            <div className="mb-6">
              <Label htmlFor="brand-description" className="block font-medium mb-2 text-gray-700 dark:text-gray-200">
                Description
              </Label>
              <Textarea
                ...
                onChange={handleInputChange}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-3 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                placeholder="Describe your brand and its values"
                rows={4}
                required
              />
            </div>
            <div className="mb-6">
              <Label htmlFor="target-audience" className="block font-medium mb-2 text-gray-700 dark:text-gray-200">
                Target Audience
              </Label>
              <Input
                id="target-audience"
                ...
                onChange={handleInputChange}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-3 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                placeholder="e.g., Gen Z, eco-conscious consumers"
                required
              />
            </div>
            <Button
      ...
      case 2:
        return (
          <>
            <div className="mb-6">
              <Label htmlFor="keywords" className="block font-medium mb-2 text-gray-700 dark:text-gray-200">
                Keywords
              </Label>
              <Input
                id="keywords"
            ...
            <div className="mb-6">
              <Label htmlFor="min-followers" className="block font-medium mb-2 text-gray-700 dark:text-gray-200">
                Minimum Followers
              </Label>
              <Input
                id="min-followers"
            ...
            <div className="mb-6">
              <Label htmlFor="platforms" className="block font-medium mb-2 text-gray-700 dark:text-gray-200">
                Preferred Platforms
              </Label>
              <Input
                id="platforms"
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Selected: {formData.brandValues.length}/5</p>
            </div>
            <div className="mb-6">
          ...
          <>
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                Think about the &quot;vibe&quot; that resonates with your brand. Is it creative and energetic? Calm and
                thoughtful? Bold and adventurous?
              </p>
            </div>
            <div className="flex gap-3">
              <Button
    ...
    <div className="pt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-purple-800 dark:text-purple-300 mb-2">Find Your Perfect Match</h1>
        ...
        {matches.length > 0 && (
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-purple-300 mb-2">Influencers with Matching Vibes</h2>
              <p className="text-gray-400">
                Found {matches.length} {matches.length === 1 ? "influencer" : "influencers"} that{" "}
                {matches.length === 1 ? "matches" : "match"} your brand's identity
              </p>
            </div>
